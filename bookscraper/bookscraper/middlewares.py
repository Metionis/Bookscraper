...
class ScrapeOpsFakeUserAgentMiddleWare:
    ...
    def __init__(self, settings):
        self.scrapeops_api_keys =  settings.get('SCRAPEOPS_API_KEYS')
        self.scrapeops_endpoint = settings.get('SCRAPEOPS_FAKE_USER_AGENT_ENDPOINT', 'https://headers.scrapeops.io/v1/user-agents?api_key=9243adb3-c085-466e-bd04-e8d89da5974f')
    ...
    def _get_user_agents_list(self):
        payload = {'api_key': self.scrapeops_api_keys}
    ...
    def _scrapeops_fake_user_agents_enabled(self):
        if self.scrapeops_api_keys is None or self.scrapeops_api_keys == '':
...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_fake_browser_header_active = settings.get("SCRAPEOPS_FAKE_BROWSER_HEADER_ACTIVE")
    ...
    def process_request(self, request, spider):
        ...
        request.headers['upgrade-insecure-request'] = random_browser_header.get('upgrade-insecure-request')
